...
namespace CartridgesManager {
    public static class GuiController {
        ...
        private static Dictionary<string, LinearButton> ControlsDictionary { get; set; } = new Dictionary<string, LinearButton>();
        ...
        /// <returns></returns>
        private static string GetCode(LinearButton control) {
        ...
        /// <returns></returns>
        public static string RegisterControl(this LinearButton control, ControlCallback callback) {
            ...
            (control as LinearButton).ButtonClick += (s, e) =>
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public static string RegisterControl(this LinearButton control, long code, ControlCallback callback) {
        ...
        /// </summary>
        /// <param name="control"></param>
        public static void UnregisterControl(this LinearButton control) {
        ...
        /// <param name="code"></param>
        /// <returns></returns>
        public static LinearButton GetAssociatedControl(string code) {
